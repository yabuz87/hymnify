...
function AdminDashboard() {
  ...
  const { songs, fetchOwnerSongs, isLoadingSongs, uploadSong, deleteSong } = useSongStore();
  ...
  // Aggregate Songs into "Albums" logically
  ...
  const handleModalSubmit = async (e) => {
    ...
    const success = await uploadSong(authUser._id, songPayload);
            ...
            <div className="modal-body">
              ...
              <div className="modal-footer" style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem' }}>
                ...
                <button type="submit" className="btn-primary">
                  <i className="bi bi-cloud-arrow-up-fill me-2"></i> Upload Song
                </button>
              </div>
          </form>
        </div>
